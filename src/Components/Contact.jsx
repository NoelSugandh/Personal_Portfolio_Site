const socialLinks = [
  {
    href: "https://github.com/NoelSugandh",
    icon: (
      <svg
        width="24"
        height="24"
  ...
  {
    href: "http://linkedin.com/in/noel-sugandh-motupalli",
    icon: (
      <svg
        width="24"
        height="24"
  ...
  {
    href: "https://sacredheart.joinhandshake.com/profiles/cg97jh",
    icon: <img src="../images/handshake.svg" className="logo-img" />,
    alt: "Handshake",
  },
];
  ...
  return (
    <section id="contact" className="section">
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
            ...
            {socialLinks.map(({ href, icon }, key) => (
              <a
                ...
                className="w-12 h-12 grid place-items-center ring-inset
                         ring-2 ring-zinc-50/5 rounded-lg transition-[background-color,color] hover:bg-zinc-50
        ...
        <form
          action="https://getform.io/f/alllrrna"
          method="POST"
          className="xl:pl-10 2xl:pl-20"
        >
          <div
            className="md:grid md:items-center md:grid-cols-2
                md:gap-2"
          >
            <div className="mb-4">
            ...
            <div className="mb-4">
              ...
              <input
                ...
                autoComplete="email"
                required
                placeholder="noelsugandh@example.com"
                className="text-field reveal-up"
              />
            </div>
          </div>
